        ...
        <div className="space-y-8 animate-fade-in-up">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-[15px] text-slate-500 mt-1">Track and manage your talent pipeline.</p>
                </div>
                <div className="flex gap-3">
                    <button
                        onClick={() => setBlindMode(!blindMode)}
                        className={`flex items-center gap-2 px-4 py-2 rounded-[10px] font-medium text-[14px] transition-colors border ${blindMode ? 'bg-slate-800 text-white border-slate-800' : 'bg-white text-slate-700 border-slate-200 hover:bg-slate-50'}`}
                    >
                        {blindMode ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                        {blindMode ? 'Blind Mode On' : 'Blind Mode Off'}
                    </button>
                    <button className="flex items-center gap-2 bg-white border border-slate-200 text-slate-700 px-4 py-2 rounded-[10px] font-medium text-[14px] hover:bg-slate-50 transition-colors">
                        <Download className="w-4 h-4" /> Export CSV
                    </button>
                    <button className="flex items-center gap-2 bg-brand-600 text-white px-4 py-2 rounded-[10px] font-medium text-[14px] hover:bg-brand-700 transition-colors shadow-sm shadow-brand-500/20">
            ...
            <Card className="p-4 flex flex-col md:flex-row gap-4 items-center justify-between sticky top-0 z-10">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto overflow-x-auto">
                    <select
                        className="px-3 py-2.5 bg-white border border-slate-200/60 rounded-[10px] text-[13px] font-medium text-slate-600 focus:outline-none focus:border-brand-500 cursor-pointer"
                        value={filterRole}
                                ...
                                >
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            />
                                            <div>
                                                <div className="font-semibold text-[14px] text-slate-900 group-hover:text-brand-600 transition-colors">
