...
import { ShieldCheck, Camera, RefreshCw, CheckCircle, ArrowRight, Monitor, Scan, User, CreditCard, AlertCircle } from 'lucide-react';
      ...
      <Card className="w-full max-w-2xl p-8 md:p-12 bg-white shadow-2xl shadow-slate-200/50 border border-slate-100 rounded-3xl transition-all duration-300">
                    ...
                    {verificationStage === 'selfie' && !selfieImage && (
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            ...
                            <div className="absolute bottom-4 bg-black/50 text-white text-xs px-3 py-1 rounded-full backdrop-blur-sm">
                                <User className="w-3 h-3 inline mr-1"/> Face Guide
                            </div>
                        </div>
                    )}
        ...
        {step === 3 && (
           <div className="text-center py-8 animate-fade-in-up">
              ...
              <p className="text-slate-500 mb-8 max-w-md mx-auto leading-relaxed">Lumina is ready for you. The session will be recorded for quality and compliance purposes. Good luck!</p>
              
              <button onClick={() => navigate('/interview/room')} className="inline-flex items-center gap-2 bg-brand-600 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-brand-700 transition-all transform hover:scale-105 shadow-xl shadow-brand-500/30">
