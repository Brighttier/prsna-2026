...
export const Onboarding = () => {
    ...
    const [formData, setFormData] = useState({
        companyName: store.getState().settings.branding.companyName || '',
        industry: '',
        size: '',
        brandColor: '#16a34a',
            ...
            case 4: // Launch
                return (
                    <div className="text-center animate-fade-in">
                        ...
                        <div className="bg-slate-50 rounded-2xl p-6 text-left max-w-sm mx-auto border border-slate-100">
                        ...
                        <div className="flex items-center gap-2">
                            {currentStep === steps.length - 1 ? (
                                <button
                                    ...
                                    disabled={loading}
                                    className="px-8 py-3 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-500/30 flex items-center gap-2"
                                >
