...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles, Shield, Zap, Users } from 'lucide-react';
...
export const Login = () => {
    ...
    const features = [
        { icon: Sparkles, title: 'AI-Powered Screening', desc: 'Intelligent candidate matching' },
        { icon: Shield, title: 'Enterprise Security', desc: 'Bank-level encryption' },
        { icon: Zap, title: 'Lightning Fast', desc: 'Process 1000s in seconds' },
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-teal-600 to-green-500 p-12 flex-col justify-between relative overflow-hidden">
                ...
                <div className="relative z-10 grid grid-cols-2 gap-4">
                    {features.map((feature, idx) => (
                        <div key={idx} className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 border border-white/20 hover:bg-white/20 transition-all">
                ...
                <div className="relative z-10 bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-white/70 text-xs">Head of Talent, TechCorp</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl shadow-emerald-100 p-8 border border-slate-100">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                type="submit"
                                className="w-full py-3.5 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold rounded-xl hover:from-emerald-700 hover:to-teal-700 transition-all shadow-lg shadow-emerald-500/30 flex items-center justify-center gap-2 group"
                            >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button className="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-all font-medium text-slate-700">
