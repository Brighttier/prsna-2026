                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl shadow-emerald-100 p-8 border border-slate-100">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button type="button" className="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-all font-medium text-slate-700">
